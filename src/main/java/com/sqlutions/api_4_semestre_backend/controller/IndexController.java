...
public class IndexController {
        ...
        public List<Index> getRadarIndexesSeries(@RequestParam(defaultValue = "1") int minutes,
                        @RequestBody Radar[] radars,
                        @RequestParam(required = false) java.time.LocalDateTime timestamp) {
        ...
        public List<Index> getRegionIndexSeries(@RequestParam(defaultValue = "1") int minutes,
